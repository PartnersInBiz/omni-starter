...
definePageMeta({
  title: 'Legions Messaging',
  layout: 'empty',
  preview: {
    title: 'Legions Messaging app',
...
const { legionsConversations: conversations } = useLegions()
...
const selectedConversation = computed(() => {
  return conversations.value.find(
    (conversation: { id: number }) =>
      conversation.id === activeConversation.value,
  )
})
...
<template>
  <div class="relative">
    <Modal :open="openAdd" :size="'3xl'" @close="openAdd = false">
      <!-- Body -->
      <div class="h-screen overflow-auto p-4">
        <legion-create :is-edit-modal="isEditModal" @close="openAdd = false" />
      </div>
    </Modal>
    <div class="bg-muted-100 dark:bg-muted-900 flex min-h-screen">
      ...
      >
        <div class="flex h-full flex-col">
          ...
          >
            <BaseAvatar :src="conversation.user.avatar" size="sm" />
          </a>
        </div>
      </div>
        ...
        <div class="relative flex w-full flex-col px-8">
          ...
          <div v-else class="mt-8">
            <div class="flex items-center justify-center">
              <BaseAvatar :src="selectedConversation?.user.avatar" size="2xl" />
            </div>
