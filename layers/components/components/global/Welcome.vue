...
<template>
  <div class="mx-auto max-w-4xl pb-16">
    ...
    <div class="flex flex-col gap-3 pb-16 pt-8 text-center">
      ...
      <LogoText class="text-primary-500 mx-auto h-8" />
    </div>
    <BaseCard shape="curved" class="dark:!bg-muted-900 mb-4 p-8 sm:mb-6">
      ...
      <div class="space-y-2 pt-6 text-center">
        ...
        >
          Welcome to the Omni app starter. You are here because you ran the
          <code
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Reviewing Omni's documentation is essential to get a grasp on all
          ...
          <div>
            <div class="flex gap-2 sm:items-center">
              ...
              <p>
                ...
                <a href="/" target="_blank">Online documentation</a>
              </p>
            </div>
          </div>
        </BaseProse>
