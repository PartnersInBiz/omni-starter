...
export const createWeaviate = async (
  docs,
  attributeInfo,
  indexName,
  textKey = 'text',
  ...
  console.log('host', config.WEAVIATE.host)
  console.log('apiKey', config.WEAVIATE.apiKey)
  console.log('headers', config.OPENAI.secret)
